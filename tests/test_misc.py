...
import requests
from immich_lib.api.misc import MiscellaneousMixin
...
class TestMiscellaneousMixin(unittest.TestCase):
    def setUp(self):
        ...
        # Create a minimal mock client that inherits from MiscellaneousMixin
        self.client = type("MockClient", (MiscellaneousMixin,), {})()
