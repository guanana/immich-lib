...
import requests
from immich_lib.api.partners import PartnersMixin
...
class TestPartnersMixin(unittest.TestCase):
    def setUp(self):
        ...
        # Create a minimal mock client that inherits from PartnersMixin
        self.client = type("MockClient", (PartnersMixin,), {})()
